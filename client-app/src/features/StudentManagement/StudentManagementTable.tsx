          ...
          <TableBody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <Button sx={{background:'#3690E3', color:'#ffffff', border:'1px solid #ffffff', borderRadius:'8px', boxShadow:'none', width:'95px'}} variant="contained" onClick={() => handleClick(row.msv)}>Duyệt</Button>
                  </TableCell>
                </TableRow>
              ))}
          </TableBody>
